...
{
    public abstract class SanPhamDAL
    {
        private string maSP;
        ...
        protected SanPhamDAL(string maSP, string tenSP, double trongLuong, double giaBan, string xuatXu, DateTime ngaySanXuat)
        {
            this.maSP = maSP;
            this.tenSP = tenSP;
